...
function TObj_Pais.existeRelacionamentoByEndereco: boolean;
var
  qrSelect: TFDQuery;
begin
   result := false;
   ...
   qrSelect.SQL.Clear;
   qrSelect.SQL.Add('SELECT codigo FROM endereco WHERE(pais = :pais)');
...
function TObj_Pais.getUltimoCodigoInserido: integer;
var
